...
const ShinAIChatbot = {
    ...
    generateFallbackResponse: function(userMessage) {
        ...
        if (msg.includes('サービス') || msg.includes('料金') || msg.includes('価格') || msg.includes('費用')) {
            return 'ShinAIでは、AIシステム開発、カスタムAI開発、RAG構築、AIエージェント開発など、幅広いAIソリューションを提供しております。お客様のニーズに合わせたオーダーメイド開発が可能です。料金はプロジェクトの規模やご要望によって異なりますので、詳しいお見積もりについてはお問い合わせフォームよりご相談ください。';
        }
