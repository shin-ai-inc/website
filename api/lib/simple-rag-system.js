...
【AI検索システムによる情報提供】
ご質問に最適な情報を見つけるため、高度なAI検索システムを使っています。
- ベクトル検索（70%）：意味の近さで関連情報を探します
- キーワード検索（30%）：的確な語彙マッチング
- AIによる関連性判定：より適切な情報を選び出します
- 質問意図の理解：本当に知りたいことを汲み取ります

このシステムで、ご質問に一番合った情報をお届けします。
